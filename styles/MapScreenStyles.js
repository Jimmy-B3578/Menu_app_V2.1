...
export default StyleSheet.create({
  ...
  modalView: {
    ...
    backgroundColor: colors.modal.background, // Background color of the modal
    borderRadius: 10, // Rounded corners
    padding: 35, // Inner padding
    alignItems: 'center', // Center items horizontally inside the modal
    shadowColor: colors.card.shadow, // Shadow for iOS
  ...
  recenterButton: {
    ...
    backgroundColor: colors.map.recenterButton, // Semi-transparent white
  ...
  createButtonDisabled: {
    backgroundColor: colors.button.disabled, // Greyed out color
  },
  ...
  contextButtonHalf: {
    backgroundColor: colors.secondary, // Use secondary theme color
    paddingVertical: 12,
  ...
  contextButtonText: {
    color: colors.button.text, // Use theme color or fallback
    fontWeight: 'bold',
    fontSize: 14,
  },
  ...
  loadingContainer: {
    ...
    alignItems: 'center',
    backgroundColor: colors.background, // Use theme background or fallback
  },
  ...
  backToSearchButton: {
    ...
    left: 15,
    backgroundColor: colors.map.backToSearchButton,
    paddingVertical: 8,
